...
<?= $this->section('title') ?>News & Drops<?= $this->endSection() ?>
    ...
    <div class="col-lg-6">
      <div class="card card-news shadow h-100">
        ...
        <div class="card-body">
          ...
          <a href="<?= base_url('collections/local/drop26') ?>" class="btn btn-non">Shop Drop 26</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-6">
      <div class="card card-news shadow h-100">
        ...
        <div class="card-body">
          ...
          <a href="<?= base_url('collections/collab/Manga26') ?>" class="btn btn-outline-primary">Notify Me</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-6">
      <div class="card card-news shadow h-100">
        ...
        <div class="card-body">
          ...
          <a href="<?= base_url('collections/collab/DDD') ?>" class="btn btn-non">View Teaser</a>
        </div>
      </div>
    </div>
